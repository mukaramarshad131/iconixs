...
import { useUserActions, useUserInfo, useUserPermissions } from '@/store/userStore';
...
<br/>Address:${user.location.line1}, ${user.location.country}, ${user.location.state} ${user.location.zip}</p>`, // HTML format for the intake
          },
          {
  ...
  return (
    <div className='w-full flex justify-center'>
      <Form layout="vertical" form={form} onFinish={OnFinish} className='container'>
        ...
        <Row>
          <Col span={24} lg={24}>
            <Form.Item label="TextArea">
              <Input.TextArea showCount maxLength={100} placeholder="Type here" />
            </Form.Item>
          </Col>
        </Row>
        <Form.Item>
          <Button type="primary" htmlType="submit" className="w-full !bg-[#0c2345]">
            Submit
          </Button>
        </Form.Item>
      </Form>
