    ...
    <svg viewBox="0 0 480 360" className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="BG" x1="19.496%" x2="77.479%" y1="71.822%" y2="16.69%">
          <stop offset="0%" stopColor={'#0c2345'} />
          <stop offset="100%" stopColor={'#0c2345'} stopOpacity="0" />
        </linearGradient>
      </defs>
      <path
        fill="url(#BG)"
      ...
      <defs>
        ...
        >
          <stop stopColor={'#1b3352'} />
          <stop offset="1" stopColor={'#040e1f'} />
        </linearGradient>
        <linearGradient
      ...
      <image href={Character3.src} height="300" x="312" y="30" />
    </svg>
  );
}
